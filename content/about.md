...
I am an AI Research Lead with a Ph.D. in Engineering from the [University of Toronto](https://www.utoronto.ca/) (2025), an M.Eng. from [McGill University](https://www.mcgill.ca/), and a B.Eng. from [Beijing Institute of Technology](https://english.bit.edu.cn/), where I graduated first in my major. During my academic journey, I also conducted research at [UC Berkeley](https://www.berkeley.edu/) and at the [Montreal Institute for Learning Algorithms (MILA)](https://mila.quebec/en/).
...
Beyond academia, I have collaborated widely with companies (including interned or consulting) such as [Momenta](https://www.momenta.ai/), [Megvii](https://en.megvii.com/), [SINOVATION VENTURES](https://www.chuangxin.com/), [QCraft](https://qcraftai.com/), [RCT.AI](https://www.rct.ai/), [Huawei](https://www.huawei.com/), [BioMap](https://www.biomap.com/), [Skywork AI](https://www.skywork.ai/), [ESAPIENS](https://app.esapiens.ai/sapiens) and several AI related companies, contributing to research incubation, product innovation, and deployment of large-scale AI systems. These experiences have equipped me with both scientific depth and practical perspectives across distributed systems, embodied AI, and LLM-based applications.
